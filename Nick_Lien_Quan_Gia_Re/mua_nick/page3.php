    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="alert alert-info" role="alert">
                    ...
                    <p></p><p>100% Nick Liên Quân Đúng Mật Khẩu</p>
            ...
            <div class="m-l-10 m-r-10">
                <form class="form-inline m-b-10" role="form" method="get">
                    ...
                    <div class="col-md-3 col-sm-4 p-5 no-radius">
                        ...
                        <a class="btn c-square m-l-0 btn-danger" href="https://shopnamlay.com/garena/nick-lien-quan-gia-re">Tất cả</a>
                    </div>
                </form>
            </div>
        </div>
                ...
                <div class="classWithPad">
                    <div class="image">
                        ...
                        <a href="http://localhost/Quynh/Nick_Lien_Quan_Gia_Re/638529.php">
                            <img src="/Quynh/upload-usr/images/">
        ...
        <div class="data_paginate paging_bootstrap paginations_custom" style="text-align: center">
            <ul class="pagination pagination-sm">
                ...
                <li class="page-item"><a class="page-link" href="http://localhost/Quynh/Nick_Lien_Quan_Gia_Re/mua_nick/page2.php" rel="prev">«</a></li>



                <li class="page-item"><a class="page-link" href="http://localhost/Quynh/Nick_Lien_Quan_Gia_Re/mua_nick/page1.php">1</a></li>
