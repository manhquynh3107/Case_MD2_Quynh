            ...
            <div class="c-navbar-wrapper clearfix">
                ...
                <nav class="menu-main-mobile c-mega-menu c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-fonts-uppercase c-fonts-bold hidden-md hidden-lg">
                    ...
                    <ul class="nav navbar-nav c-theme-nav">
                        ...
                        <li><a href="http://localhost/Quynh/Log_In/Log_in.php" class="c-btn-border-opacity-04 c-btn btn-no-focus c-btn-header btn btn-sm c-btn-border-1x c-btn-dark c-btn-circle c-btn-uppercase c-btn-sbold">
                                <i class="icon-user"></i> Đăng nhập</a>
                        </li><li><a href="http://localhost/Quynh/Sign_In/Sign_In.php" class="c-btn-border-opacity-04 c-btn btn-no-focus c-btn-header btn btn-sm c-btn-border-1x c-btn-dark c-btn-circle c-btn-uppercase c-btn-sbold">
                                <i class="icon-key icons"></i> Đăng ký</a>
                        </li></ul>
            ...
            <div class="c-shop-product-details-4">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <div class="c-product-header">
                            <div class="c-content-title-1">
                                <button type="button" href="http://localhost/Quynh/Log_In/Log_in.php" class="btn c-btn btn-lg c-theme-btn c-font-uppercase c-font-bold c-btn-square m-t-20 load-modal" rel="http://localhost/Quynh/Log_In/Log_in.php">Mua ngay</button>
                                ...
                                <a class="btn c-btn btn-lg c-bg-green-4 c-font-white c-font-uppercase c-font-bold c-btn-square m-t-20" href="http://localhost/Quynh/Home/INDEX.php">Nạp thẻ cào</a>
                            </div>
                        </div>
                    </div>
                </div>
